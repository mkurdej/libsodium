...
fe_tobytes(unsigned char *s, const fe h)
{
    ...
    s[1]  = (char) (h0 >> 8);
    s[2]  = (char) (h0 >> 16);
    s[3]  = (char) ((h0 >> 24) | (h1 * ((uint32_t) 1 << 2)));
    s[4]  = (char) (h1 >> 6);
    s[5]  = (char) (h1 >> 14);
    s[6]  = (char) ((h1 >> 22) | (h2 * ((uint32_t) 1 << 3)));
    s[7]  = (char) (h2 >> 5);
    s[8]  = (char) (h2 >> 13);
    s[9]  = (char) ((h2 >> 21) | (h3 * ((uint32_t) 1 << 5)));
    s[10] = (char) (h3 >> 3);
    s[11] = (char) (h3 >> 11);
    s[12] = (char) ((h3 >> 19) | (h4 * ((uint32_t) 1 << 6)));
    s[13] = (char) (h4 >> 2);
    s[14] = (char) (h4 >> 10);
    s[15] = (char) (h4 >> 18);
    s[16] = (char) (h5 >> 0);
    s[17] = (char) (h5 >> 8);
    s[18] = (char) (h5 >> 16);
    s[19] = (char) ((h5 >> 24) | (h6 * ((uint32_t) 1 << 1)));
    s[20] = (char) (h6 >> 7);
    s[21] = (char) (h6 >> 15);
    s[22] = (char) ((h6 >> 23) | (h7 * ((uint32_t) 1 << 3)));
    s[23] = (char) (h7 >> 5);
    s[24] = (char) (h7 >> 13);
    s[25] = (char) ((h7 >> 21) | (h8 * ((uint32_t) 1 << 4)));
    s[26] = (char) (h8 >> 4);
    s[27] = (char) (h8 >> 12);
    s[28] = (char) ((h8 >> 20) | (h9 * ((uint32_t) 1 << 6)));
    s[29] = (char) (h9 >> 2);
    s[30] = (char) (h9 >> 10);
    s[31] = (char) (h9 >> 18);
}
